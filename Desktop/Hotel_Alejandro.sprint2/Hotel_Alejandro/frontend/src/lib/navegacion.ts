...
export const MODULOS: ItemNavegacion[] = [
...

  {
    ...
    ruta: "/proveedores",
    hijos: [
      { nombre: "Nuevo proveedor", ruta: "/proveedores" },
      { nombre: "Comprobantes", ruta: "/proveedores/comprobantes" },
      { nombre: "Tipos de comprobante", ruta: "/proveedores/tipos-comprobante" },
      {
  ...
  },
{
  ...
  hijos: [
    ...
    },
    {
      ...
      ruta: "/habitaciones/tipos",
    },
    {
      nombre: "Tarifas",
      ruta: "/habitaciones/tarifas",
    },
    {
      nombre: "Panel de habitaciones",
      ruta: "/habitaciones/panel",
    },
  ],
},
