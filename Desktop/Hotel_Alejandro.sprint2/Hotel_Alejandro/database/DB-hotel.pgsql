...
-- ============================================================
-- Sincronización automática de total_amount en purchase_order
-- ============================================================
...
DROP TRIGGER IF EXISTS tr_sync_purchase_order_total ON purchase_order_detail;

CREATE TRIGGER tr_sync_purchase_order_total
AFTER INSERT OR UPDATE OR DELETE
ON purchase_order_detail
FOR EACH ROW
EXECUTE FUNCTION fn_sync_purchase_order_total();

-- Actualizar las órdenes de compra que ya existen en 0
UPDATE purchase_order po
SET total_amount = COALESCE(
    (
        SELECT SUM(pod.quantity * pod.unit_price)
