      ...
      <PageHeader
        ...
        acciones={
          <div className="flex items-center gap-3">
            <Link href="/habitaciones/tarifas">
              <Button variante="secundario">Gestionar tarifas</Button>
            </Link>
            <Link href="/habitaciones/tipos">
              <Button>Administrar tipos</Button>
            </Link>
          </div>
        }
      />
            ...
            {tiposVisibles.map((tipo) => {
              ...
              return (
                <div
                  ...
                  className="flex flex-col justify-between overflow-hidden rounded-xl border border-line bg-white shadow-sm"
                >
                  {/* Encabezado */}
                  <div>
                  ...
                  {/* Acciones de Navegación (Criterio HAB-04) */}
                  <div className="flex items-center justify-between border-t border-line bg-bone/30 px-5 py-3">
                    <Link
                      href={`/habitaciones/tipos?editar=${tipo.room_type_id}`}
                      className="inline-flex items-center gap-1.5 text-xs font-medium text-carbon/70 hover:text-carbon hover:underline"
                    >
                      <Pencil size={13} />
                      Editar tipo
                    </Link>
                    ...
                    <Link
                      href={`/habitaciones/tarifas?tipo=${tipo.room_type_id}`}
                      className="inline-flex items-center gap-1.5 text-xs font-medium text-gold hover:text-gold/80 hover:underline"
                    >
                      Modificar tarifa
                      <ArrowRight size={13} />
                    </Link>
